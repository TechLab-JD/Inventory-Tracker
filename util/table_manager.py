...
Updating All Details
    ...
    Item Name: {next(item['name'] for item in data['items'] if item['name'] == updated_item.get('name', item_name))}
    Cost: {next(item['cost_price'] for item in data['items'] if item['name'] == updated_item.get('name', item_name))}
    Value: {next(item['selling_price'] for item in data['items'] if item['name'] == updated_item.get('name', item_name))}
    Quantity: {next(item['quantity'] for item in data['items'] if item['name'] == updated_item.get('name', item_name))}
    Category: {next(item['category'] for item in data['items'] if item['name'] == updated_item.get('name', item_name))}     
    """)
